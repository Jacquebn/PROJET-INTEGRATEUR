// Realisation du projet integrateur  - Parfait
int i =0;
...
const int HighL = 9;       //RIGHT SIDE MOTOR
const int LowL =8;
...
void Right3()
{
  ...
  digitalWrite(HighR, LOW);
  digitalWrite(LowR, HIGH);
  analogWrite(EnableR,60);   //100
  
}

// Realisation du projet integrateur  - Lin
void UTurn()
{
  analogWrite(EnableL, 0);
  analogWrite(EnableR, 0);
